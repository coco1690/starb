            ...
            let listaeventos = Object.keys(o).map(idevent => {
                ...
                return (
                    ...
                    <tr key={y.idmatch} >
                        ...
                        <th>
                            <th className= "botn btn btn:active btn:hover" style={{}} onClick={y.data[19992] ?this.props.addTocart.bind(this, y.idmatch, datalocal1):''}>{y.data[19992] ? y.data[19992].o1 : ""} </th>
