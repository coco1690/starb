                    ...
                    <div style={{ background: 'rgba(255,255,255,0.1)' }}>
                        ...
                        <div className="mm" >
                            <div style={{ marginTop: 20, margin: 10 }}>
                                ...
                                <input id="amount" placeholder="Ej: 2000" type="number" style={{ boxSizing: 'border-box', height: 30, width: 140, border: 'hidden', outline: 'none', padding: 5, textAlign: 'right', marginLeft: 109 }} value={this.props.stake} onChange={this.props.changeStake} />
                            </div>
